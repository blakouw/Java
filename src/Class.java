...
public class Class {
    ...
    public Class(String nazwaGrupy, List<Student> grupa, double maksymalnaIloscStudentow) {
    ...
    public Student search(String nazwisko) {
        for (Student student : grupa) {
            if (student.compareTo(new Student("",nazwisko,true,true,true,1,1))==0) {
    ...
    public List<Student> searchPartial(String string) {
        ...
        for (Student student : grupa) {
            if (student.imie.toLowerCase().contains(string.toLowerCase()) || student.nazwisko.contains(string.toLowerCase())) {
